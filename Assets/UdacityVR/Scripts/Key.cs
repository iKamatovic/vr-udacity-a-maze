...
public class Key : MonoBehaviour {
	...
	void Update () {
        ...
        gameObject.transform.Rotate(0f,  0f, Time.deltaTime * 100);
    }
	...
	public void OnKeyClicked () {
        ...
        Object.Instantiate(keyPoofPrefab, transform.position, keyPoofPrefab.transform.rotation);
        Object.Destroy(gameObject, 0.5f);

        door.Unlock();

        EventTrigger keyEventTrigger = GetComponent<EventTrigger>();
        keyEventTrigger.enabled = false;
    }
}
